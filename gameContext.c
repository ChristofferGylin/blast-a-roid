...
void loadAssets(GameContext* ctx) {
    ...
    initAnimation(&ctx->assets.animations.supernova, "./assets/animations/supernova.png", "./assets/animations/supernova.json", 24.0f, (Vector2){SUPERNOVA_RENDER_SIZE, SUPERNOVA_RENDER_SIZE}, true);
