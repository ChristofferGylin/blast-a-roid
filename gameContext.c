...
void loadAssets(GameContext* ctx) {
    ...
    initAnimation(&ctx->assets.animations.metalAsteroid, "./assets/metal_asteroid.png", "./assets/metal_asteroid.json", 24.0f, (Vector2){METAL_ASTEROID_SIZE, METAL_ASTEROID_SIZE, true}, true);
